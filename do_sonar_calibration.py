...
def file_listen(watchDir):
    ...
    # This function has not been tested to work!!    
    
    # Note. need to add a check to prevent the last file being repeatidly opened
    # and the last ping used over and over again
