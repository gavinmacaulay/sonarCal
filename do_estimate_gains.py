...
class sonarReader:
    def __init__(self, config):
        ...
        for ff in files:
            with h5py.File(ff, 'r') as f:
                ...
                start_time = cftime.num2pydate(start_time/1e6,'milliseconds since 1601-01-01 00:00:00')
    ...
    def TSFromSonarNetCDF4(self, f, beamGroup, ping, beam, tilt):
        ...
        if eqn_type == 'type_2':
            ...
            G_T = f[beamGroup + '/time_varied_gain'][ping] # a value for each sample in the current ping
